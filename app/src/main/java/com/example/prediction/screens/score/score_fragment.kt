package com.example.prediction.screens.score
...
import com.example.prediction.databinding.ScoreFragmentBinding
...
//        viewModelFactory = ScoreViewModelFactory(args.score)
        ...
        viewModel.eventPlayAgain.observe(viewLifecycleOwner, Observer { playAgain ->
            if (playAgain) {
                findNavController().navigate(score_fragmentDirections.actionScoreFragmentToGameFragment())
